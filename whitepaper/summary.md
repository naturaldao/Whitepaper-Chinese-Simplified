...
**道易程是以太坊dApp和通证经济的公共治理层。价值证明（PoV，Proof of Value）是其独创的治理共识。道易程的使命是以价值为导向，让通证经济得以蓬勃发展，让智能公器（Smart Commons）得以繁衍生息。**

## 什么是价值证明（PoV，Proof of Value）？

价值证明（PoV，Proof of Value）是道易程原创的治理dApp和通证经济的共识机制。
