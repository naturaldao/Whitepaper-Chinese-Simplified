...
**道易程是一个以太坊 DAOs/dApps 的通证经济行为的基础治理层。**

也可以这样说：道易程是一个通过基础的通证经济行为的治理让 DAOs/dApps 繁衍生息、蓬勃发展的公开平台。

只需几分钟时间，任何人都可以用其开发的智能合约在道易程上 mint 一个 DAO（去中心化自治智能体），接受道易程对其基础通证经济行为的良好治理，接下来这家 DAO 就可以正式运作了！

是的，道易程为 DAO 的铸造和运行准备了非常独特的基础：道易程框架和完全开放的dApp市场。

在道易程框架中，它内置的多种协议和通用的 IADD 网络将在DAO代币的发行和市场供应、定价通证的锻造、去中心化交易、去中心化支付、去中心化基金会等方面提供统一的应用标准、技术标准和全局功能，实际上道易程司职的是以上所有环节中 DAO 的基本通证经济行为的有效治理。而说到治理，特别值得一提的是具备技术标准和应用标准双重创新的 IADD 网络在去中心化交易和去中心化支付方面做到了合二为一，并且其永久性的运行完全无人值守。
...
2020年一个小小的病毒，已经让我们这个高度中心化的世界破绽百出，甚至某些方面已有分崩离析之嫌。人类社会毫无疑问迫切需要区块链来提供有力的支撑，修正我们对 DAO 的认知迫在眉睫！
...
_你可以把最近出现的很多人类协作的DAO（1.0的DAO）视为大家正在摸索区块链协作治理的链下部分，而我们这里讨论的 DAO 2.0 则是**至少**其链上的核心得到有效治理的DAO。**简而言之：道易程是以太坊公链之上的一个治理层，而链上通证经济行为接受道易程治理（良好的链上治理）的DAO就是 2.0 的 DAO。**_

_**DAO 2.0 意味着这类DAO的核心都可以描绘为：**_

1. DAO = 共识 + 通证 + 智能合约 + 智能算法\
   我们已经知道通证和智能合约是区块链的两大硬核。**而对于DAO来说，我们认为每个DAO必须智能合约化，才能完成良好的自我治理。**
...
现在有数十个团队，在以太坊客户端、以太坊网络的扩展层（如Layer2）、EIPs（以太坊改进提案）三个层面进行协作，以完成以太坊2.0的宏图大业。这将使得ETH2.0完成之时，其工程量可领先于单个公链数十年之久。另外，以太坊2017年引爆区块链，现在以太坊上已经有成千上万个DApp，无论是项目总数、通证经济总量和活跃度，都超越其它大多数公链十年至数十年。由此可知，以太坊2.0很有可能在公链竞争中脱颖而出，所以我们目前以太坊作为道易程的基础。我们也已经将解决一切通证的链上去中心化存储方案总结为[**EIP-2569**](https://github.com/ethereum/EIPs/pull/2569)，以及我们创立的新的通证标准[EIP-3712](https://github.com/naturaldao/EIPs/blob/Eip-Branch/EIPS/eip-3712.md)，贡献给了以太坊社区。
