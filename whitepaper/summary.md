...
只需几分钟时间，任何人都可以用其开发的智能合约在道易程上 mint 一个 DAO（去中心化自治智能体），并且，这家 DAO 已经可以开始运作了！

是的，道易程为 DAO 的创建和运行准备了非常独特的基础：道易程框架和完全开放的dApp市场。

在道易程框架中，它内置的多种协议和通用的 IADD 网络将在DAO代币的市场供应、定价通证的锻造、去中心化交易、去中心化支付、去中心化基金会等方面提供统一的应用标准、技术标准和全局功能，实际上道易程实践的是以上所有环节中 DAO 的基本通证经济行为的有效治理。而说到治理，特别值得一提的是具备技术标准和应用标准双重创新的 IADD 网络在去中心化交易和去中心化支付方面做到了合二为一，并且完全无人值守。
...
同样很容易理解的是，最极致的治理最小化，就是像班科一样，通过智能合约中的算法来治理其中的币价——智能合约才是一家DAO的核心。

_你可以把最近出现的很多人类协作的DAO（1.0的DAO）视为大家正在摸索区块链协作治理的链下部分，而我们这里讨论的 DAO 2.0 则是**至少**其链上的核心得到有效治理的DAO。**简而言之：道易程是以太坊公链之上的一个治理层，而链上通证经济行为接受道易程治理（良好的链上治理）的DAO就是DAO 2.0。**_

_**DAO 2.0 意味着这类DAO的核心都可以描绘为：**_

1. DAO = 共识 + 通证 + 智能合约 + 智能算法\
   我们已经知道通证和智能合约是区块链的两大硬核。**而对于DAO来说，我们认为每个DAO还必须智能合约化，才能完成良好的自我治理。**
...
**对于道易程而言，DAO的链下部分可以是任何人、任何组织，道易程本身并不关联这一部分。道易程只专注于DAO的链上部分（即其智能合约）的通证经济行为的基础治理。**
