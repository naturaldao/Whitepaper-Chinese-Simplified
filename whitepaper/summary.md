...
2. 以奖励为驱动力\
   每笔价值通证交易需缴纳2%的手续费，并奖励给对应的DAO的开发者。这种奖励机制可以驱动所有的dApp成为公共资源/公共品（Public Goods）。
3. 驱动所有的dApp成为公共资源/公共品（Public Goods）\
   Mint DAO意味着开发者自愿将其开发的dApp转为公共资源。这一协议（特别是其子协议SP0）符合 DAism 对培育公共资源/公共品和开放协作生态系统的承诺。
