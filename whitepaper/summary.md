...
**道易程是以太坊通证经济和智能公器的公共治理层。价值证明（PoV，Proof of Value）是其独创的治理共识。道易程的使命是让通证经济得以蓬勃发展，让智能公器（Smart Commons）得以繁衍生息。**
...
如果你开发了一个dApp，愿意接受道易程价值证明的治理，那么你只需1分钟时间，在道易程上 mint 一个 智能公器，即可。而如果你的dApp是有价值的，那么此后你就可以源源不断地获得奖励。是的，PoV提供的奖励是永续的！
...
2. 以奖励为驱动力\
   每笔估值通证交易需缴纳0.2%的手续费，并奖励给对应的dApp的开发者。这种奖励机制可以驱动所有的dApp成为智能公物（Smart Commons）。
