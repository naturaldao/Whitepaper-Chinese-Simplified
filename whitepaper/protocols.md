...
> **SC0 v0.1**
>
> 用一个dApp Mint DAO意味着该dApp接受本协议成为其唯一协议，也接受其所有者和管理者（我们称之为DAO的成员）全部匿名这一事实。
>
> 1、无著作权
>
> 匿名意味着其开发的dApp完全贡献至公共领域，成为公共资源，除享受价值证明（Proof-of-Work）带来的奖励外，放弃所有其它权利，包括所有相关权利和邻接权利。
>
> 2、无责任
>
