...
* 道易程 IADD 網絡里的支付協議和定價通證協議，與本協議密切相關：如某DAO發行了代幣，則出售產品或服務（其價格單位必須是 vita）以及收取交易手續費時，不管付費者支付的實際是何種代幣，該DAO的 DAF 均遵守該協議確保收取的是自己的代幣。如該DAO未發行代幣，則它只能收取支付幣種 uToken。
