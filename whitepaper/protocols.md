...
同时，该协议中还包含了一个智能资产子协议，其名称为 SC0（意为Smart Commons 0）。即Minting操作，也就是宣布某个智能合约或某个dApp（某些智能合约的组合）自身成为以太坊的公共资源（Public Goods）——我们称其为智能公物（Smart Commons ）。这也就是说，接受道易程治理的dApp，即为智能公物。

> **SC0 v0.1**
>
> 用一个dApp Mint一个 DAO 意味着该dApp接受本协议成为其唯一协议，也接受其所有者和管理者（我们称之为DAO的成员）全部匿名这一事实。
>
> 因为匿名，无人可证明某人是任何权利的享有者，也无人可证明某人是任何责任的背负者。
>
> 1、无著作权
>
> 匿名意味着其开发的dApp完全贡献至公共领域，成为智能公物（Smart Commons），除能够享受价值证明（Proof-of-Work）带来的奖励外，彻底放弃所有其它权利，包括所有相关权利和邻接权利。
>
> 2、无责任
>
> 匿名意味着该DAO的成员，无法对其dApp及其专属估值通证提供任何形式的担保，无法承担任何连带责任。
>
...
任何一个DAO都会发行其专属的估值用通证（中文也可以称其为估值用代币）。估值通证的主要作用是让投资者参与dApp的价值评估，并为道易程的共识价值证明提供奖金。
